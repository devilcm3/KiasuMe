...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'member_profile', (
            ...
            ('user_pk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.Profile'])),
        ...
        db.create_table(u'member_profile_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm[u'member.profile'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'member_profile_groups', ['profile_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'Profile'
        db.create_table(u'member_profile_user_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm[u'member.profile'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(u'member_profile_user_permissions', ['profile_id', 'permission_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('member_profile_groups')

        # Removing M2M table for field user_permissions on 'Profile'
        db.delete_table('member_profile_user_permissions')
    ...
    models = {
        ...
        u'member.profile': {
            ...
            'user_pk': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['member.Profile']"}),
