...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.slug'
        db.add_column(u'deal_deal', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.slug'
        db.delete_column(u'deal_deal', 'slug')
    ...
    models = {
        ...
        u'deal.deal': {
            ...
            'promo_thumbnail': ('django.db.models.fields.URLField', [], {'default': "'media/deal/2013/04/28/44f6fe2f-4458-410c-bd58-1ccd49ba5f80.jpeg'", 'max_length': '250', 'null': 'True', 'blank': 'True'}),
