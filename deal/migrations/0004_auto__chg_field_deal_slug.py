...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.slug'
        db.alter_column(u'deal_deal', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Deal.slug'
        db.alter_column(u'deal_deal', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        u'deal.deal': {
            ...
            'date_ended': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 28, 0, 0)'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'promo_thumbnail': ('django.db.models.fields.URLField', [], {'default': "'media/deal/2013/04/28/3fd7b729-4027-4b24-967c-3ec63391f569.jpeg'", 'max_length': '250', 'null': 'True', 'blank': 'True'}),
