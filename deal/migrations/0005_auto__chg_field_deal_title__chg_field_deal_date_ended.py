...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.title'
        db.alter_column(u'deal_deal', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Deal.date_ended'
        db.alter_column(u'deal_deal', 'date_ended', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Deal.title'
        db.alter_column(u'deal_deal', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Deal.date_ended'
        db.alter_column(u'deal_deal', 'date_ended', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'deal.deal': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'promo_thumbnail': ('django.db.models.fields.URLField', [], {'default': "'media/deal/2013/05/11/fab0e545-fe5f-4d4b-b633-d6c657d8b958.jpeg'", 'max_length': '250', 'null': 'True', 'blank': 'True'}),
