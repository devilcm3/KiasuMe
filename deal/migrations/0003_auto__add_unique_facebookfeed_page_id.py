...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FacebookFeed', fields ['page_id']
        db.create_unique(u'deal_facebookfeed', ['page_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookFeed', fields ['page_id']
        db.delete_unique(u'deal_facebookfeed', ['page_id'])
    ...
    models = {
        ...
        u'deal.deal': {
            ...
            'promo_thumbnail': ('django.db.models.fields.URLField', [], {'default': "'media/deal/2013/08/26/dcc4cfa5-fbb7-4426-ad71-6ee6e5b9bee2.jpeg'", 'max_length': '250', 'null': 'True', 'blank': 'True'}),
        ...
        u'deal.facebookfeed': {
            ...
            'page_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100', 'blank': 'True'}),
