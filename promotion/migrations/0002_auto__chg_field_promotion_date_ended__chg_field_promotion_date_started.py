...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Promotion.date_ended'
        db.alter_column(u'promotion_promotion', 'date_ended', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Promotion.date_started'
        db.alter_column(u'promotion_promotion', 'date_started', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Promotion.date_ended'
        db.alter_column(u'promotion_promotion', 'date_ended', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Promotion.date_started'
        db.alter_column(u'promotion_promotion', 'date_started', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'promotion.promotion': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
