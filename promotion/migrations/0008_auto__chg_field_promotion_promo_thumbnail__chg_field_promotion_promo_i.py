...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'promotion_promotion', 'promo_thumbnail', self.gf('django.db.models.fields.SlugField')(max_length=250, null=True))

        # Changing field 'Promotion.promo_image'
        db.alter_column(u'promotion_promotion', 'promo_image', self.gf('django.db.models.fields.files.ImageField')(max_length=250))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Promotion.promo_image'
        db.alter_column(u'promotion_promotion', 'promo_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'promotion.promotion': {
            ...
            'date_ended': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 17, 0, 0)'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 17, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'promo_thumbnail': ('django.db.models.fields.SlugField', [], {'default': "'media/promotion/2013/04/17/1a6cf41e-e2d0-47dc-aff2-a572b92bf19a.jpeg'", 'max_length': '250', 'null': 'True', 'blank': 'True'}),
