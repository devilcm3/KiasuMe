...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promotion.promo_thumbnail'
        db.add_column(u'promotion_promotion', 'promo_thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promotion.promo_thumbnail'
        db.delete_column(u'promotion_promotion', 'promo_thumbnail')
