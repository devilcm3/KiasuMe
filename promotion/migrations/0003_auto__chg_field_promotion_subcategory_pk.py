...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Promotion.subcategory_pk'
        db.alter_column(u'promotion_promotion', 'subcategory_pk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotion.Subcategory'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Promotion.subcategory_pk'
        raise RuntimeError("Cannot reverse this migration. 'Promotion.subcategory_pk' and its values cannot be restored.")
    ...
    models = {
        ...
        u'promotion.promotion': {
            ...
            'date_ended': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 6, 0, 0)'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 6, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
