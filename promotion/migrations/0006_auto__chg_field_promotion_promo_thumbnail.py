...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Promotion', fields ['promo_thumbnail']
        db.create_index(u'promotion_promotion', ['promo_thumbnail'])


    def backwards(self, orm):
        # Removing index on 'Promotion', fields ['promo_thumbnail']
        db.delete_index(u'promotion_promotion', ['promo_thumbnail'])


        # Changing field 'Promotion.promo_thumbnail'
        db.alter_column(u'promotion_promotion', 'promo_thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'promotion.promotion': {
            ...
            'promo_thumbnail': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
